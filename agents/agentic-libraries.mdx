...
<CardGroup cols="2">
  <Card title="VisionAgent Library" icon="palette" href="https://github.com/landing-ai/vision-agent">
  </Card>
  <Card title="VisionAgent Library Docs" icon="code" href="https://landing-ai.github.io/vision-agent/">
  </Card>
</CardGroup>
