...
<CardGroup cols={2}>
  <Card
    title="VisionAgent Library"
    icon="palette"
    href="https://github.com/landing-ai/vision-agent"
  >
    Check out the VisionAgent library
  </Card>
  <Card
    title="VisionAgent Library Docs"
    icon="code"
    href="https://landing-ai.github.io/vision-agent/"
  >
    Learn more in the library docs
  </Card>
</CardGroup>
